...
parser.add_argument(
    ...
    default='/content/drive/MyDrive/CS492I/final/video/video4.mp4'
)
...
checkpoint = torch.load('/content/drive/MyDrive/CS492I/final/outputs/best_model_resnet_v3.pth', map_location=DEVICE)
...
out = cv2.VideoWriter(f"/content/drive/MyDrive/CS492I/final/test_predictions/{save_name}_inference.mp4",
